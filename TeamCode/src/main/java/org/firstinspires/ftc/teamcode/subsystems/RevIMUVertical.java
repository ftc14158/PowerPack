...
public class RevIMUVertical extends GyroEx {
     ...
     */
    public RevIMUVertical(HardwareMap hw, String imuName) {
     ...
     * @param hw Hardware map
     */
    public RevIMUVertical(HardwareMap hw) {
        this(hw, "imu");
    }
    ...
    public void reset( double newHeading ) {
        offset = newHeading - getHeading();
    }
